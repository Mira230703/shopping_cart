...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CK5oAj20.mjs')
  },
  {
    name: "product-id",
    path: "/product/:id()",
    component: () => import('./_id_-B8_Dd7Mi.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B9KhsNGY.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C1Voy0_8.mjs'));
